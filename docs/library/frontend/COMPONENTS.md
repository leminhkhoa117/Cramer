...
**Purpose:** Image cropping interface using react-easy-crop.
...
**Purpose:** Conditional render based on subscription tier.

```jsx
<FeatureGate requiredTier="cramerich" fallback={<UpgradePrompt />}>
  <PremiumFeature />
</FeatureGate>
```
