...
| **Admin Pages** | 11 | AdminDashboard, UserList, TestEditor, AIGeneration, etc. |
| **Total** | **27** | - |
...
| Page | CSS File(s) |
|------|-------------|
| Home | `home.css`, section-specific CSS |
| Login | `login.css` |
| Dashboard | `dashboard.css`, `sidebar-layout.css` |
| TestPage | `test-page.css`, `test-header.css`, `test-footer.css` |
| WritingTestPage | `writing-test-page.css` |
| WritingResultPage | `writing-result-page.css` |
| TestReviewPage | `test-review-page.css` |
| Profile | `profile-page.css`, `sidebar-layout.css` |
| VocabularyPage | `vocabulary-page.css` |
| SubscriptionPage | `subscription-page.css`, `sidebar-layout.css` |
| PricingPage | `pricing-page.css` |
| Admin Pages | `admin/css/pages/**/*.css` |
