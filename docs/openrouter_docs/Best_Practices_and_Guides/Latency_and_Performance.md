...
When using model routing or provider routing, if the primary model or provider fails, OpenRouter will automatically try the next option. 
...
2. **Use Provider Preferences**
   * If you have specific latency requirements, there are provider routing features to help you achieve your performance and cost goals.
