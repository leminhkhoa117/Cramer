...
| `test_id` | bigint | NO | - | FK → `tests.id` |
| `session_mode` | varchar(20) | NO | - | `FULL`, `PART_1`, `PART_2`, `PART_3`, `PART_2_AND_3` |
...
| `grading_attempts` | integer | NO | `0` | Number of grading attempts (max 2) |
| `last_grading_error` | text | YES | - | Error message from last failed grading attempt |
