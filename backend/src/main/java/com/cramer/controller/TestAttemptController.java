...
public class TestAttemptController extends BaseController {
    ...
    public ResponseEntity<TestAttempt> startOrGetAttempt(
        ...
        logger.info("📥 POST /api/test-attempts/start - source={}, test={}, skill={}, forceNew={}",
                   source, test, skill, forceNew);
    ...
    public ResponseEntity<TestResultDTO> submitAttempt(
        ...
        logger.info("🔐 User authenticated: userId={}, answersCount={}",
                   userId, submissionDTO.getAnswers().size());

        TestResultDTO result = testAttemptService.submitAttempt(id, submissionDTO.getAnswers(), userId);
        logger.info("✅ Test submitted successfully: score={}/{}",
