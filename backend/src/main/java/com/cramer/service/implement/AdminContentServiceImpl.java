...
/**
 * Admin Content Service Implementation - Xử lý logic quản lý nội dung đề thi cho Admin CMS
 * 
 * OPTIMIZED VERSION: Sử dụng batch queries và caching để giảm số lượng database calls
 */
@Service
public class AdminContentServiceImpl implements AdminContentService {
    ...
    private String formatDisplayName(String examSource) {
        if (examSource == null) return "Unknown";
    ...
    public Map<String, Object> updateSection(Long sectionId, Map<String, Object> sectionData, String adminUserId) {
        try {
            ...
            if (sectionData.containsKey("sectionLayout")) {
                ...
                params.add(sectionData.get("sectionLayout") != null ? sectionData.get("sectionLayout").toString() : null);
            }
    ...
    public Map<String, Object> updateQuestion(Long questionId, Map<String, Object> questionData, String adminUserId) {
        try {
            ...
            if (questionData.containsKey("questionContent")) {
                ...
                params.add(questionData.get("questionContent") != null ? questionData.get("questionContent").toString() : null);
            }
            if (questionData.containsKey("correctAnswer")) {
                sql.append(", correct_answer = ?::jsonb");
                params.add(questionData.get("correctAnswer") != null ? questionData.get("correctAnswer").toString() : null);
            }
    ...
    @Override
    public Map<String, Object> updateTestStatus(String examSource, Integer testNumber, String status, String adminUserId) {
        try {
            // Validate status
