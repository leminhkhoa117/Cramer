...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle IllegalStateException (e.g., trying to cancel non-IN_PROGRESS attempt).
     */
    ...
    /**
     * Handle AccessDeniedException (IDOR protection).
     */
    ...
    public ResponseEntity<Object> handleRateLimitExceededException(
        ...
        logger.warn("⚠️ Rate limit exceeded: {}", ex.getMessage());
